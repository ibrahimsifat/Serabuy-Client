        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                At Serabuy, accessible from Serabuy dot com, one of our
                ...
                and recorded by Serabuy and how we use it. If you have
              ...
              <p>
                ...
                information that they shared and/or collect in Serabuy.we may
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                Serabuy follows a standard procedure of using log files.
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                the advertising partners of Serabuy. Third-party ad servers
                ...
                links that appear on Serabuy, which are sent directly to
                ...
                that you visit. Note that Serabuy has no access to or control
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                respective advertisements and links that appear on Serabuy,
                which are sent directly to users' browser. They automatically
                receive your IP address when this occurs. These technologies are
                used to measure the effectiveness of their advertising campaigns
                and/or to personalize the advertising content that you see on
                websites that you visit. Note that Serabuy has no access to
                or control over these cookies that are used by third-party
                advertisers.
              </p>
              <p>
                Serabuy's Privacy Policy does not apply to other advertisers
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              ...
              <p>
                Serabuy does not knowingly collect any Personal Identifiable
