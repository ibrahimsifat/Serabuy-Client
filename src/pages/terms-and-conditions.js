      ...
      <div className="bg-white">
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-3 sm:px-10">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                the use of Serabuy's Website, located at
                https://Serabuy.com/. By accessing this website we assume you
                accept these terms and conditions. Do not continue to use
                Serabuy if you do not agree to take all of the terms and
          ...
          <div className="mb-6 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                We employ the use of cookies. By accessing Serabuy, you
                agreed to use cookies in agreement with the Serabuy's Privacy
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                Unless otherwise stated, Serabuy and/or its licensors own the
                intellectual property rights for all material on Serabuy. All
                intellectual property rights are reserved. You may access this
                from Serabuy for your own personal use subjected to
